...
export default function HeroSection() {
  ...
  return (
    <section className="bg-[#1A171A] h-[918px] w-full overflow-hidden relative z-[6]">
      ...
      <div className="relative z-[5] h-full flex flex-col justify-between">
        <div className="pt-[180px] px-[40px] md:px-[80px]">
          <h2 className="text-white text-[40px] sm:text-[60px] md:text-[80px] font-medium leading-[0.95] tracking-tight text-left animate-fade-in-up">
            Marrakech Property Service
          </h2>
          <div className="mt-4">
            <p className="text-white text-[20px] sm:text-[25px] md:text-[30px] font-normal leading-[1.2] text-left animate-fade-in-up animation-delay-200">
        ...
        <div className="flex flex-col md:flex-row items-stretch gap-[10px] px-[10px] pb-[10px] animate-fade-in-up animation-delay-400">
          <div className="flex-1 bg-[#274038]/90 backdrop-blur-sm rounded-[8px] flex items-center justify-between p-[14px_23px]">
            <div className="flex flex-col">
              <h5 className="text-[16px] font-medium text-white mb-[4px]">
            ...
            <a
              ...
              className="btn-hover bg-[#FBEFDD] text-[#1A171A] text-[16px] font-normal px-[32px] py-[15px] rounded-[6px] hover:bg-[#F5D6AB] transition-colors min-h-[44px] no-underline whitespace-nowrap"
            >
              List Your Property
            </a>
          </div>
          ...
          <div className="flex items-center bg-[#4F0003]/90 backdrop-blur-sm rounded-[8px] overflow-hidden">
            <div className="flex items-center gap-[12px] p-[14px_20px]">
              <div className="flex flex-col">
